...
var tgen1 = btgf.createObject("tgen1", [
    ...
    {withPrefix: "dest",
     withKey: hub2, "prob": 1.0, "overflowProb": 0.0},
    {withPrefix: "timeline", withIndex: [
	{"time": MKS.hours(3), "running": false},
	{"time": MKS.hours(6), "running": true,
	 "meanIATime": MKS.minutes(30)}]},
]);

var tgen2 = btgf.createObject("tgen2", [
    {"startingHub": hub2, "meanIATime": MKS.minutes(10), "nBicycles": 1},
    {withPrefix: "dest",
      withKey: hub1, "prob": 1.0, "overflowProb": 0.0},
    {withPrefix: "timeline", withIndex: [
	{"time": MKS.hours(3), "running": false},
	{"time": MKS.hours(6), "running": true,
	 "meanIATime": MKS.minutes(30)}]}]);
