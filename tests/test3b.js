...
var balancer = hbf.createObject("balancer", {
    "quietPeriod": 0, "threshold": 0.75, "sysDomain": sysDomain
});
...
for each (var i in [usrDomain, sysDomain, balancer, hub1, hub2,
		    storageHub,
		    userTable, sysTable, worker1, tgen1, tgen2]) {
...
var traceset = tsf.createObject("traceset", {
    level: 4
});
traceset.setOutput(output);
// balancer.addTraceSet(traceset);
