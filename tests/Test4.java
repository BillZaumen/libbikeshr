...
public class Test4 {
	...
	balancer.setQuietPeriod(MKS.minutes(2));
	...
	*/
	...
	storageHub.setInitialNumberOfWorkers(0, 1, 0,
					     0.0, MKS.minutes(30.0), 0.0);
	storageHub.addHub(HubWorker.Mode.LOOP_WITH_PICKUP, hub1);
	storageHub.addHub(HubWorker.Mode.LOOP_WITH_PICKUP, hub2);
	...
	tgen1.init(hub1, MKS.minutes(11.0), 1, hubs1, weights, overflowProb);
