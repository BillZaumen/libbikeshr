...
scripting.importClass("org.bzdev.io.DirectoryAccessor");
...
if (typeof da == undefined) {
    ...
    // Set up a graph so that it is written to the specified file.
    // The image type is determined from the file name.
    var gout = da.getOutputStream(filename);
    var gtype = OutputStreamGraphics.getImageTypeForFile(filename);
