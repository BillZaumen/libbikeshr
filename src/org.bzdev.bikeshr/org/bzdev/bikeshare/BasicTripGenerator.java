 ...
 * these trips, BasicTripGenerator allows one to specify the number of
 ...
 * overflow area.
 */
public class BasicTripGenerator extends TripGenerator {
     ...
     */
    public BasicTripGenerator(DramaSimulation sim,
			      String name,
			      boolean intern)
    {
     ...
     * {@inheritDoc}
     * <P>
     * Defined for class BasicTripGenerator:
     * <UL>
...
//  LocalWords:  BasicTripGenerator printConfiguration sim sfpf
